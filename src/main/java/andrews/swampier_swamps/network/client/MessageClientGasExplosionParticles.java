...
{
    public static ResourceLocation PACKET_ID = new ResourceLocation(Reference.MODID, "gas_explosion_particles_packet");
    ...
    public static void registerPacket()
    {
        ClientPlayNetworking.registerGlobalReceiver(PACKET_ID, (client, handler, buf, responseSender) ->
        {
            ...
            client.execute(() ->
            {
                ...
                ClientPacketHandlerClass.handleSpawnGasExplosionParticles(pos);
            });
        });
    }
}